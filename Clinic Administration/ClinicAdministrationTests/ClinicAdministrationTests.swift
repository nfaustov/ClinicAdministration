...
//            )!,
//            endingTime: Calendar.current.date(
//                from: DateComponents(year: 2021, month: 1, day: 1, hour: 12, minute: 00)
//            )!
//        )
...
//            )!,
//            endingTime: Calendar.current.date(
//                from: DateComponents(year: 2021, month: 1, day: 1, hour: 14, minute: 30)
//            )!
//        )
...
//            )!,
//            endingTime: Calendar.current.date(
//                from: DateComponents(year: 2021, month: 1, day: 1, hour: 16, minute: 00)
//            )!
//        )
...
//            )!,
//            endingTime: Calendar.current.date(
//                from: DateComponents(year: 2021, month: 1, day: 1, hour: 18, minute: 00)
//            )!
//        )
...
//            )!,
//            endingTime: Calendar.current.date(
//                from: DateComponents(year: 2021, month: 1, day: 1, hour: 18, minute: 30)
//            )!
//        )
//
//        let dataSource = TimeTableDataManager(schedules: [schedule5, schedule1, schedule2, schedule4, schedule3])
...
//        )
//
//        let dataSource = TimeTableDataManager(schedules: [schedule1, schedule2])
