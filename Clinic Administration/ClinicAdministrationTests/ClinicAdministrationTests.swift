...
class ClinicAdministrationTests: XCTestCase {
    ...
    func testDetectingIntersections() {
        ...
        let schedule1 = DoctorSchedule(
            ...
            secondName: "test1", firstName: "test1", patronymicName: "test1",
            cabinet: 3,
        ...
        let schedule2 = DoctorSchedule(
            ...
            secondName: "test2", firstName: "test2", patronymicName: "test2",
            cabinet: 3,
            startingTime: Calendar.current.date(
        ...
        let schedule3 = DoctorSchedule(
            ...
            secondName: "test3", firstName: "test3", patronymicName: "test3",
            cabinet: 3,
            startingTime: Calendar.current.date(
        ...
        let schedule4 = DoctorSchedule(
            ...
            secondName: "test4", firstName: "test4", patronymicName: "test4",
            cabinet: 3,
            startingTime: Calendar.current.date(
        ...
        let schedule5 = DoctorSchedule(
            ...
            secondName: "test5", firstName: "test5", patronymicName: "test5",
            cabinet: 3,
            startingTime: Calendar.current.date(
